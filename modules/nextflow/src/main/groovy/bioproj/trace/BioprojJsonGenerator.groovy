...
@Slf4j
@CompileStatic
class BioprojJsonGenerator extends DefaultJsonGenerator {

    List<String> stack = new ArrayList<>(10)
    Map<String,Integer> scheme

    static BioprojJsonGenerator create(Map<String,Integer> scheme) {
        ...
        return new BioprojJsonGenerator(opts, scheme)
    }

    protected BioprojJsonGenerator(Options options, Map<String,Integer> scheme) {
        super(options)
        this.scheme = scheme
    }
