...
FROM registry.cn-hangzhou.aliyuncs.com/sj-bioinfo/ubuntu-jdk:21
...
WORKDIR /bin
COPY build/releases/nextflow-24.08.0-edge-dist nextflow
WORKDIR /home
...
# docker build -t registry.cn-hangzhou.aliyuncs.com/sj-bioinfo/nextflowdev:24.08.0  .
