...
# 
install:
	BUILD_PACK=1 gradle8.4  installLauncher publishToMavenLocal -Dmaven.repo.local=${HOME}/.nextflow/capsule/deps/
...
#
release:
	BUILD_PACK=1 gradle8.4 release
...
#
dockerPack:
	BUILD_PACK=1 gradle8.4 publishToMavenLocal dockerPack -Dmaven.repo.local=${PWD}/build/docker/.nextflow/capsule/deps/
